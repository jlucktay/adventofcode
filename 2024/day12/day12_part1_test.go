...
garden plots are growing the same type of plant and are touching (horizontally or vertically), they form a region. For
example:
...
import (
	...
	"go.jlucktay.dev/adventofcode/2024/day12"
)
...
EEEC
`, 140},
		"regions within regions": {`OOOOO
OXOXO
OOOOO
OXOXO
OOOOO
`, 772},
		"larger example": {`RRRRIICCFF
RRRRIICCCF
VVRRRCCFFF
VVRCCCJFFF
VVVVCJJCFE
...
`, 1930},
	...
	for desc, testCase := range testCases {
		t.Run(desc, func(t *testing.T) {
			...
			got, err := day12.Part1(testCase.in)
			is.NoErr(err)
